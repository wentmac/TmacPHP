...
$db[ 'default' ][ 'hostname' ] = '192.168.1.188';    //数据库主机地址 冒号后面是端口
$db[ 'default' ][ 'port' ] = '3306';    //数据库主机地址 冒号后面是端口
$db[ 'default' ][ 'username' ] = 'zhangwentao';                //数据库连接账户名
$db[ 'default' ][ 'password' ] = 'X1dcunb8a5scSd0aupkF';                 //数据库连接密码
$db[ 'default' ][ 'database' ] = "message";               //数据库名
...
define( 'INDEX_URL', 'http://dev.tuhao.weixinshow.com/' ); //主域名
define( 'ADMIN_URL', 'http://dev.tuhao.weixinshow.com/' ); //主域名
define( 'MOBILE_URL', 'http://dev.tuhao.weixinshow.com/' ); //主域名
define( 'STATIC_URL', 'http://dev.public.tuhao.weixinshow.com/' ); //static url
define( 'UPLOAD_URL', 'http://img.tuhao.weixinshow.com/' ); //图片上传的host
...
define( 'UPAPI_KEY', 'upfile_kuailezu_01@' ); //图片上传接收的私钥
