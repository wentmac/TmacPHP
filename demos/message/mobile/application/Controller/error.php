 ...
 * $Id: error.php 594 2014-12-14 04:52:57Z zhangwentao $
 * http://www.t-mac.org；
 */
class errorAction extends service_Controller_mobile
{
    ...
    public function test()
    {
        ...
        $string = '0204';
        //echo $des->encode($string);
        echo '<br>';
        echo $des->decode('wNnOAZXo050=');
        die;
        /**
        ...
        $trade_no = '4001032001201604184959716971';
...
// we have multiple image tags (without value)
    ...
    public function refund()
    {
        ...
        $order_refund_id = 299;
        $res = array(
            'out_refund_no' => '20160325231326_299',
            'refund_fee' => '8800',
            'transaction_id' => '4000702001201603254274488564',
            'refund_id' => '2000702001201603250188745365'
        );
