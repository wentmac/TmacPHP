...
0
|| self::check('default\member/agent_level.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\member\agent_level.tpl', 1460617190)
;?>
<html>
        ...
        <div class="affiliate-list text-center">
          <div class="well user-well text-center">
            ...
            <h4 class="color-333 text-center text-overflow"><?php echo $memberInfo->nickname;?></h4>
              ...
              <div class="fensi">
                <h3>我的粉丝(<?php echo count($agent_array); ?>)</h3>
                <ul>
