...
0
|| self::check('default\shop_goodslist.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\shop_goodslist.tpl', 1460881678)
|| self::check('default\shop_goodslist.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\inc/js.tpl', 1460881678)
;?>
<!DOCTYPE html>
<html>
...
var global_shop_info = JSON.parse('<?php echo $shop_info_json;?>');
...
<script src="<?php echo $BASE_V;?>js/common.js?v=201635" type="text/javascript"></script><script src="<?php echo STATIC_URL; ?>common/assets/js/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo STATIC_URL; ?>js/jquery-plugin/jquery.tmpl.min.js" type="text/javascript"></script>
