...
0
|| self::check('default\order_confirm.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\order_confirm.tpl', 1460882061)
;?>
<!DOCTYPE html>
<html>
...
<body>
  ...
  <section id="order_wrap">
    ...
    <?php if(is_array($cart_list)) foreach($cart_list AS $v) { ?>
        <li class="o_li li_for_pay" data-cart-id='<?php echo $v->cart_id;?>' data-price="<?php echo $v->item_price;?>" data-item-id="<?php echo $v->item_id;?>" data-sku-id="<?php echo $v->goods_sku_id;?>" data-count="<?php echo $v->item_number;?>" data-limit_discount_id="">
          <a href="<?php echo MOBILE_URL; ?>goods/<?php echo $v->goods_id;?>.html" class="o_a rel block"><img src="<?php echo $v->goods_image_id;?>" width="50" height="50" class="left">
            <p class="o_name"><?php echo $v->goods_name;?></p>
    ...
    <section id="order_money" class="hide" style="display: block;">
      ...
      <p id="delivery_service_money" class="r_txt">邮费: &nbsp;<span id="delivery_service_money_span" class="i_pri">¥<?php echo $shipping_fee;?></span>
      	共<?php echo count($cart_list); ?>件商品，总商品金额:&nbsp;<span id="delivery_service_money_span" class="i_pri">¥<?php echo $total_price;?></span>
      	
      </p>
      <p id="count_money_wrap" class="r_txt">合计:&nbsp;<span class="i_pri">¥<?php echo $total_amount;?></span></p>
    ...
    <footer id="order_footer" class="wrap fix hide" style="display: block;">
      <div id="order_btns" class="wrap rel margin_auto">
        <div id="order_btns_inner">
          ...
          <p id="last_money" class="r_txt">应付总额:&nbsp;<span class="i_pri" id="last_money_show">¥<?php echo $total_amount;?></span></p>
        </div>
      </div>
    </footer>
  </section>
