...
0
|| self::check('default\message/list.tpl', 'D:\Web\Witkey\wwwroot\tuhao\trunk\admin\application\View\default\message\list.tpl', 1462966533)
|| self::check('default\message/list.tpl', 'D:\Web\Witkey\wwwroot\tuhao\trunk\admin\application\View\default\inc/header_paul.tpl', 1462966533)
|| self::check('default\message/list.tpl', 'D:\Web\Witkey\wwwroot\tuhao\trunk\admin\application\View\default\inc/sidebar_paul.tpl', 1462966533)
|| self::check('default\message/list.tpl', 'D:\Web\Witkey\wwwroot\tuhao\trunk\admin\application\View\default\inc/footer_paul.tpl', 1462966533)
;?>
<!DOCTYPE html>
<html>
				...
				<div class="am-g" id="condition_list">
					...
					<div class="am-u-sm-7">
						<div class="am-input-group am-input-group-lg">   						
							...
							<input type="text" name="start_date" id="start_date" class="am-form-field" value="<?php echo $start_date;?>" placeholder="开始时间" data-am-datepicker readonly required />
							<span class="am-input-group-label am-radius">结果日期</span>
							<input type="text" name="end_date" id="end_date" class="am-form-field" value="<?php echo $end_date;?>" placeholder="结束时间" data-am-datepicker readonly required />
...
<script type="text/javascript">
	...
	var message_class_array = <?php echo $message_class_array;?>;
</script>
...
<script src="<?php echo $BASE_V;?>js/message_list.js?v=4" type="text/javascript"></script>
