...
<html>
	...
	<head>
		...
		<link href="{$BASE_V}amazeui/css/amazeui.css" rel="stylesheet" type="text/css">
		<link href="{$BASE_V}amazeui/css/admin.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="{$BASE_V}amazeui/js/amazeui.min.js"></script>
<script type="text/javascript" src="{$BASE_V}js/amazeui.switch.min.js"></script>
<script type="text/javascript" src="{$BASE_V}amazeui/echarts/echarts-all.js"></script>
