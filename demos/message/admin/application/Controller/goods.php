 ...
 * http://www.t-mac.org；
 */
class goodsAction extends service_Controller_admin
{
    ...
    public function index()
    {
        ...
        $goods_model = new service_goods_GoodsList_admin();
...
//     die;
    ...
    public function add()
    {
        ...
        $goods_model = new service_goods_admin_admin();
        //$goods_id = 29;
...
//        die;
    ...
    public function save()
    {
        ...
        $goods_save_model = new service_goods_GoodsSave_admin();
    ...
    public function add_spec_value()
    {
        ...
        $spec_model = new service_Spec_admin();
    ...
    public function batch_category()
    {
        ...
        $model = new service_goods_admin_admin();
    ...
    public function custom_price()
    {
        ...
        $model = new service_goods_Price_admin();
