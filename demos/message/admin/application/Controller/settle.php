 ...
 * $Id: category.php 6 2014-09-20 15:13:57Z zhangwentao $
 * http://www.t-mac.org；
 */
    ...
    public function bank_card_save()
    {
        ...
        switch ( $account_type )
        {
            case service_settle_Save_base::default_account_type_bank:
                ...
                $bank_id_array = Tmac::config( 'member.member_setting.bank_id', APP_admin_NAME );
        ...
        //检测验证码是否正确
        $check_model = new service_account_Register_admin();
        ...
        //保存银行卡信息
        $model = new service_MemberSetting_admin();
        $model->setUid( $this->memberInfo->uid );
