 ...
 * $Id: article.php 330 2016-06-01 14:04:25Z zhangwentao $
 * http://www.t-mac.org；
 */
class articleAction extends service_Controller_admin
{
    ...
    public function get_list()
    {
        ...
        $model = new service_Article_admin();
        //TODO  取出所有资讯
...
//        die;
    ...
    public function save()
    {
        ...
        $archives_model = new service_Archives_admin();
        ...
        $article_model = new service_Article_admin();
        if ( $aid > 0 ) {
            //update save article            
