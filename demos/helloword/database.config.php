...
$db[ 'default' ][ 'password' ] = 'rootadmin';                 //数据库连接密码
$db[ 'default' ][ 'database' ] = "helloword";               //数据库名
...
define( 'INDEX_URL', 'http://dev.www.message.com/' ); //主域名
define( 'STATIC_URL', 'http://dev.public.weixinshow.com/' ); //static url
...
define( 'UPAPI_KEY', 'upfile_kuailezu_8_@' ); //图片上传接收的私钥
define( "PRODUCTION_MODE", FALSE ); //true production_mode|false dev_mode
