...
class Filter
{
    ...
    public function email()
    {
        ...
        if ( filter_var( self::$field, FILTER_VALIDATE_EMAIL ) === false ) {
    ...
    public function ip()
    {
        ...
        if ( filter_var( self::$field, FILTER_VALIDATE_IP ) === false ) {
    ...
    public function url()
    {
        ...
        if ( filter_var( self::$field, FILTER_VALIDATE_URL ) === false ) {
            self::setErrorMessage( 'URL格式不正确' );
            return false;
        }
        return self::$field;
    }
