$(function() {
	...
	$("#search_button").click(function() {
		...
		//$("#hot_ul").html($("#hot_ul").html() + "<li id='search_more'><a href='/plaza/searchAll.html?tb_search=1&amp;type=item' id='search_more_a' class='for_gaq btncancel' data-for-gaq='搜索更多宝身茶商品'>搜索更多宝身茶商品</a></li>")
	});
});
