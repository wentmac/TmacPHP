...
require.config ({
    ...
    paths: {
        ...
        //'vue': ['https://cdn.jsdelivr.net/npm/vue@2.5.16/dist/vue.min'],
        "zepto": [static_url + 'js/zepto.min'],
        "jquery": [static_url + 'js/jquery/1.11.2/jquery-1.11.2.min'],
...
require([
    ...
    $(document).ready(function () {
        ...
        history.pushState('', '', mobile_url+"survey/"+step_id);
        verify.init();
