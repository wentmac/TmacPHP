 ...
 * $Id: alipay.php 439 2016-10-04 09:47:05Z zhangwentao $
...
class alipayAction extends Action
{
    ...
    public function refund()
    {
        ...
        $parameter = array(
            ...
            "partner" => $this->alipay_config[ 'partner' ],
            "seller_email" => $this->alipay_config[ 'seller_email' ],
            "notify_url" => $this->alipay_config[ 'refund_notify_url' ] . '/' . $order_refund_id, //http://dev.shop.weixinshow.com/pay/alipay.autoRefund/123
