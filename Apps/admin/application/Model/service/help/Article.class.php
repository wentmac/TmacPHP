...
class service_help_Article_admin extends service_help_Article_base
{
     ...
     * return Boole
     */
    public function modifyHelpArticle( \base\entity\HelpArticle $entity_HelpArticle_base )
    {
     ...
     * return Boole
     */
    public function createHelpArticle( \base\entity\HelpArticle $entity_HelpArticle_base )
    {
        $dao = dao_factory_base::getHelpArticleDao();
    ...
    public function deleteHelpArticleId( $id )
    {
        ...
        $entity_HelpArticle_base = new \base\entity\HelpArticle();
