 ...
 * $Id: Comment.class.php 444 2016-10-07 19:03:28Z zhangwentao $
...
class service_Comment_admin extends Model
{
    ...
    public function createComment(\base\entity\Comment $entity_Comment_base)
    {
        $dao = dao_factory_base::getCommentDao();
        return $dao->insert($entity_Comment_base);
    }

    public function modifyComment(\base\entity\Comment $entity_Comment_base)
    {
        $dao = dao_factory_base::getCommentDao();
    ...
    public function modifyCommentByIds(\base\entity\Comment $entity_Comment_base)
    {
        $dao = dao_factory_base::getCommentDao();
        $dao->getDb()->startTrans();
