...
class service_goods_Save_admin extends service_goods_Save_base
{
     ...
     * 供应商的商品修改
     * $this->goods_id;
     * $this->modifySupplierGoods( \base\entity\Goods $entity_Goods_base );
     * @param \base\entity\Item $entity_Item_base
     * @param \base\entity\Goods $entity_Goods_base
     * @return boolean
     */
    public function modifyAdminGoods( \base\entity\Goods $entity_Goods_base )
    {
