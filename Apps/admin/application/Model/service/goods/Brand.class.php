...
class service_goods_Brand_admin extends service_Model_base
{
    ...
    //插入数据
    public function createBrand( \base\entity\Brand $entity_Brand_base )
    {
    ...
    //更新数据
    public function modifyBrand( \base\entity\Brand $entity_Brand_base )
    {
        $dao = dao_factory_base::getBrandDao();
    ...
    public function deleteByBrandId( $id )
    {
        ...
        $entity_brand_base = new \base\entity\Brand();
