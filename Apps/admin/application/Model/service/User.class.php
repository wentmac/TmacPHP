 ...
 * $Id: User.class.php 897 2017-02-14 02:45:10Z zhangwentao $
...
class service_User_admin extends Model
{
    ...
    public function createUser(\base\entity\User $entity_User_base)
    {
        $dao = dao_factory_base::getUserDao();
        return $dao->insert($entity_User_base);
    }

    public function modifyUser(\base\entity\User $entity_User_base)
    {
        $dao = dao_factory_base::getUserDao();
