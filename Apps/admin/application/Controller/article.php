 ...
 * $Id: article.php 444 2016-10-07 19:03:28Z zhangwentao $
...
class articleAction extends service_Controller_admin
{
    ...
    public function save()
    {
        ...
        $entity_AddArticle_base = new entity_Addonarticle_base();
        ...
        if ( $aid > 0 ) {
            ...
            $rs = $this->tmp_model->modifyArticleAll( $entity_Article_base, $entity_AddArticle_base );
            //插入Tag_info            
            if ( $rs ) {
            ...
            $article_id = $this->tmp_model->createArticleAll( $entity_Article_base, $entity_AddArticle_base );
            if ( $article_id ) {
                //插入Tag_info
