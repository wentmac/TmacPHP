 ...
 * $Author: zhangwentao $
 * $Id: factory.class.php 1011 2017-04-08 11:31:39Z zhangwentao $
 */
...
//        $database = $GLOBALS['TmacConfig']['Common']['Database'];
     ...
     * @return type
     */
    public static function getYoukuDb()
    {
//        $database = $GLOBALS['TmacConfig']['Common']['Database'];
        $database = 'youku';
        return DatabaseDriver::getInstance( $database );
    ...
    public static function getIntegralDao()
    {
        return new dao_impl_Integral_base( self::getDb() );
    }

    public static function getPayDao()
    {
        return new \base\dao\impl\Pay( self::getDb() );
    }

    public static function getTradeDao()
    {
        //return new \base\dao\impl\Trade( self::getDb() );
        return self::getDao( '\base\dao\impl\Trade', self::getDB() );
    }

    public static function getTrendDao()
    {
        return new \base\dao\impl\Trend( self::getDb() );
    }

    public static function getMemberLevelDao()
    {
        return new \base\dao\impl\MemberLevel( self::getDb() );
    }

    public static function getYoukuNoticeDao()
    {
        return new \base\dao\impl\YoukuNotice( self::getYoukuDb() );
    }

    public static function getSurveyDao()
    {
        return new \base\dao\impl\Survey( self::getDb() );
        //return self::getDao( '\base\dao\impl\Survey', self::getDB() );
    }
