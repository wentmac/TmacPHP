...
/**
 * Description of Goods.class.php
 *
...
class Goods
{
    ...
    public $goods_image_ids;
    public $goods_sort;
    public $goods_time;
    public $goods_modify_time;
    public $comment_count;
    public $goods_month_order_count;
    public $click_count;
    public $is_on_sale;
    public $sales_volume;
    ...
    public $is_delete;
    public $goods_source;
    public $goods_source_id;
    public $goods_type;
    public $goods_class;
    public $commission_fee_rank;
    public $goods_member_level;
    public $is_integral;
    public $fh_currency_need;
    public $exchange_limit_day;
}