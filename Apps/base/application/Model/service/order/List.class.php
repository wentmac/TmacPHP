 ...
 * $Id: List.class.php 439 2016-10-04 09:47:05Z zhangwentao $
...
class service_order_List_base extends service_Order_base
{
    ...
    public function getBuyerOrderList()
    {
        ...
        if ( $count > 0 ) {
            ...
            $order_info_dao->setField( 'order_id,order_sn,order_status,uid,mobile,consignee,shipping_status,pay_status,refund_status,order_amount,create_time,confirm_time,shipping_time,confirm_deadline_time,item_uid,shop_name,order_goods_detail,order_type,have_return_service,comment_status' );
