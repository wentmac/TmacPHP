 ...
 * $Author: zhangwentao $
 * $Id: EntityCreate.class.php 439 2016-10-04 09:47:05Z zhangwentao $
 */
...
class service_EntityCreate_base extends Model
{
    ...
    private $db_prefix = 'bsc';

    public function __construct()
    {
        parent::__construct();
        $this->db = $this->connect();
        $this->entity_class_dir = APPS_PATH . APP_BASE_NAME . DIRECTORY_SEPARATOR . APPLICATION . DIRECTORY_SEPARATOR . 'Model' . DIRECTORY_SEPARATOR . 'entity' . DIRECTORY_SEPARATOR;
    }
...
class ' . $entityFileName[ 'classname' ] . '
{
';
