...
class service_Category_base extends service_Model_base
{
    ...
    /**
     * 插入数据
     * @param \base\entity\Category $entity_Category_base
     * @return type
     */
    public function createCategory( \base\entity\Category $entity_Category_base )
    {
        $dao = dao_factory_base::getCategoryDao();
     ...
     * @return type
     */
    public function modifyCategoryByPk( \base\entity\Category $entity_Category_base )
    {
        $dao = dao_factory_base::getCategoryDao();
