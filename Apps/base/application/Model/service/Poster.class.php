...
class service_Poster_base extends service_Model_base
{
    ...
    public function createPoster( \base\entity\Poster $entity_Poster_base )
    {
        $dao = dao_factory_base::getPosterDao();
        return $dao->insert( $entity_Poster_base );
    }

    public function modifyPoster( \base\entity\Poster $entity_Poster_base )
    {
        $dao = dao_factory_base::getPosterDao();
    ...
    public function deletePosterId( $poster_name )
    {
        ...
        $entity_Poster_base = new \base\entity\Poster();
