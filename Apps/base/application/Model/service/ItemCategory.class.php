...
class service_ItemCategory_base extends Model
{
    ...
    /**
     * 插入数据
     * @param \base\entity\ItemCategory $entity_ItemCategory_base
     * @return type
     */
    public function createCategory( \base\entity\ItemCategory $entity_ItemCategory_base )
    {
        $dao = dao_factory_base::getItemCategoryDao();
        //判断是不是存在
     ...
     * @return type
     */
    public function modifyCategoryByPk( \base\entity\ItemCategory $entity_ItemCategory_base )
    {
        $dao = dao_factory_base::getItemCategoryDao();
    ...
    public function deleteItemCategoryById( $id, $delete_type )
    {
        ...
        if ( $delete_type == self::delete_type_delete_all_goods ) {
            ...
            $entity_Item_base = new \base\entity\Item();
