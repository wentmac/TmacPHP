 ...
 * $Id: GoodsCategory.class.php 444 2016-10-07 19:03:28Z zhangwentao $
...
class service_GoodsCategory_base extends service_Model_base
{
    ...
    /**
     * 插入数据
     * @param \base\entity\GoodsCategory $entity_GoodsCategory_base
     * @return type
     */
    public function createCategory( \base\entity\GoodsCategory $entity_GoodsCategory_base )
    {
        $dao = dao_factory_base::getGoodsCategoryDao();
     ...
     * @return type
     */
    public function modifyCategoryByPk( \base\entity\GoodsCategory $entity_GoodsCategory_base )
    {
        $dao = dao_factory_base::getGoodsCategoryDao();
