 ...
 * $Id: Collect.class.php 439 2016-10-04 09:47:05Z zhangwentao $
...
class service_member_Collect_base extends service_Model_base
{
    ...
    public function saveCollectItem()
    {
        ...
        $entity_CollectItem_base = new \base\entity\CollectItem();
    ...
    public function saveCollectShop()
    {
        ...
        $entity_CollectShop_base = new \base\entity\CollectShop();
