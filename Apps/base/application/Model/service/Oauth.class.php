...
class service_Oauth_base extends service_Model_base
{
    ...
    function getOauth_referer( $redirect_uri = '' )
    {
        if ( empty( $this->oauth_referer ) ) {
            $this->oauth_referer = Input::cookie( 'oauth_referer', $redirect_uri )->string();
        }
    ...
    public function insertMemberOauth( \base\entity\MemberOauth $entity_MemberOauth_base )
    {
        $dao = dao_factory_base::getMemberOauthDao();
        return $dao->insert( $entity_MemberOauth_base );
    }

    public function updateMemberOauthById( \base\entity\MemberOauth $entity_MemberOauth_base )
    {
        $dao = dao_factory_base::getMemberOauthDao();
     ...
     * 把oauth数据种在cookie中
     */
    public function setOauthCookie( \base\entity\MemberOauth $entity_MemberOauth_base )
    {
