 ...
 * $Id: Category.class.php 444 2016-10-07 19:03:28Z zhangwentao $
...
class service_help_Category_base extends service_Model_base
{
    ...
    /**
     * 插入数据
     * @param \base\entity\HelpCategory $entity_HelpCategory_base
     * @return type
     */
    public function createCategory( \base\entity\HelpCategory $entity_HelpCategory_base )
    {
        $dao = dao_factory_base::getHelpCategoryDao();
     ...
     * @return type
     */
    public function modifyCategoryByPk( \base\entity\HelpCategory $entity_HelpCategory_base )
    {
        $dao = dao_factory_base::getHelpCategoryDao();
