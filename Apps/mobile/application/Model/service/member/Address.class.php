 ...
 * $Id: Address.class.php 711 2016-11-28 17:54:48Z zhangwentao $
...
class service_member_Address_mobile extends service_Member_base
{
    ...
    public function createMemberAddress( \base\entity\MemberAddress $entity_MemberAddress_base )
    {
        $dao = dao_factory_base::getMemberAddressDao();
        //判断是否已经存在
    ...
    public function modifyMemberAddress( \base\entity\MemberAddress $entity_MemberAddress_base )
    {
        $this->getFullAddress( $entity_MemberAddress_base );
        $dao = dao_factory_base::getMemberAddressDao();
    ...
    /**
     * 取全路径地址
     * @param \base\entity\MemberAddress $entity_MemberAddress_base
     */
    public function getFullAddress( \base\entity\MemberAddress $entity_MemberAddress_base )
    {
     ...
     * @param \base\entity\MemberAddress $entity_MemberAddress_base
     */
    public function getFullAgentAddress( \base\entity\MemberSetting $entity_MemberSetting_base )
    {
        $entity_MemberSetting_base->agent_address = $this->getRegionNameById( $entity_MemberSetting_base->agent_province )
                . $this->getRegionNameById( $entity_MemberSetting_base->agent_city )
                . $this->getRegionNameById( $entity_MemberSetting_base->agent_district );                
        return $entity_MemberSetting_base;
    }
    ...
    public function deleteByMemberAddressById( $id )
    {
        ...
        $entity_MemberAddress_base = new \base\entity\MemberAddress();
