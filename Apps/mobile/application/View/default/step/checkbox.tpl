...
<div class="page__bd page__bd_spacing weui-cells" id="div_verify">
	...
	<!--{/if}-->
		<div class="weui-flex__item">
			<label class="weui-cell weui-check__label" for="s{$v[value]}">
				...
				<div class="weui-cell__hd">
					<input type="checkbox" class="weui-check" name="checkbox1" id="s{$v[value]}" value="{$v[value]}" v-model="checkedNames" v-on:click="choose_nothing('{$v[image_name]}','{$option_array[nothing_value]}','{$v[value]}')">
