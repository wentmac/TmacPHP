		...
		<div class="weui-flex__item">
			<label class="weui-cell weui-check__label" for="x{$v[value]}">
				<div class="weui-cell__bd">
					...
					<img class="weui-media-box__thumb" src="{$BASE_V}image/survey/{$v[image_name]}.png" alt="" width="100%" height="100%">
				</div>
...
<div class="page__bd page__bd_spacing">
	<a href="javascript:onclick=history.back()" class="weui-btn weui-btn_default" id="prev_button">上一题</a>
	<a href="{MOBILE_URL}survey/{$next_step_id}" class="weui-btn weui-btn_primary" id="confirm_button">选好了，查看评测结果</a>
