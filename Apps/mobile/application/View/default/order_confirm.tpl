...
<body>
  ...
  <section id="order_wrap">
    ...
    <section id="order_money" class="hide" style="display: block;">
      ...
      <!--{/if}-->      
      <!--{if $use_voucher_money==1 && $use_voucher_money_value>0}-->
      <p id="use_integral" class="r_txt">购物券抵扣: &nbsp;<span class="i_pri">-¥{$use_voucher_money_value}</span></p>      
      <!--{/if}-->
    ...
    <section id="order_remark">
      <p class="address_p rel <!--{if $agent_uid}-->hide<!--{/if}-->">
    ...
    <footer id="order_footer" class="wrap fix hide" style="display: block;">
      <div id="order_btns" class="wrap rel margin_auto">
        <div id="order_btns_inner">
          ...
          <!--{if $use_integral==true}-->我的可用积分：<span class="i_pri">{$available_integral}</span>   &nbsp;&nbsp;<!--{/if}-->          
          应付总额:&nbsp;<span class="i_pri" id="last_money_show">¥{$total_amount}</span>
          </p>
        </div>
      </div>
    </footer>
