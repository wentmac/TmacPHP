			...
			<footer id="item_fix_btn" class="fix hide wrap" style="-webkit-transition: opacity 200ms ease; transition: opacity 200ms ease; opacity: 1; display: block;">
				<div id="control_btn" class="margin_auto">
					<div id="control_btn_inner" class="rel">
						...
						<div id="control_btn_inner_right" class="abs"><a id="add_cart" class="c_txt abs for_gaq" data-for-gaq="加入购物车" style="display: block;">加入购物车</a> <a id="buy_now" class="btnok c_txt abs for_gaq" data-for-gaq="{$buy_now_button}" style="display: block;">{$buy_now_button}</a> <a id="control_bottom_submit" class="btnok c_txt abs"
...
<script type="text/javascript" src="{$BASE_V}js/item.js?v={STATIC_VERSION}"></script>
