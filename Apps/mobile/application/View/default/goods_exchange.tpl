			...
			<div id="item_info_for_show_wrap" class="hide" style="display: block;">
				...
				<section id="item_info" class="rel">
					...
					<div id="item_price_wrap" class="rel">
						<p>							
							<span id="item_price" class="i_pri">{$goods_info->fh_currency_need}</span> 									
							<span id="seckill_discount">富豪币抽奖</span>							
						</p>
			...
			<footer id="item_fix_btn" class="fix hide wrap" style="-webkit-transition: opacity 200ms ease; transition: opacity 200ms ease; opacity: 1; display: block;">
				<div id="control_btn" class="margin_auto">
					<div id="control_btn_inner" class="rel">
						...
						<div id="control_btn_inner_right" class="abs"><a id="add_cart" class="c_txt abs for_gaq hide" data-for-gaq="加入购物车">加入购物车</a> <a id="buy_now" class="btnok c_txt abs for_gaq" data-for-gaq="{$buy_now_button}" style="display: block;">{$buy_now_button}</a> <a id="control_bottom_submit" class="btnok c_txt abs"
                ...
                <button class="am-btn am-btn-default" id="btn_stock_add" type="button"><i class="am-icon-plus"></i></button>
					...
					<div class="sku_btn">
						<ul class="am-avg-sm-2">
							...
							<li class="">
								<button id="btn_buynow" class="am-btn am-btn-danger am-btn-block am-radius">{$buy_now_button}</button>
							</li>
						</ul>
					</div>
				</div>
...
<script type="text/javascript">
	...
	var gloabl_goods_id = {$goods_info->goods_id};
	...
	var global_goods_class = {$goods_info->goods_class};
	var global_fh_currency_need = {$goods_info->fh_currency_need};
</script>
...
<script type="text/javascript" src="{$BASE_V}js/goods_exchange.js?v={STATIC_VERSION}"></script>
