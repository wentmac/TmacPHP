...
<!--{/if}-->
  ...
  <section id="kd_status" class="kd_tle kd_status settle">
      <span class="order" style="width:100%;">
        <div class="current_money">购物券：<em>￥{$member_setting_info->voucher_money}</em></div>                
      </span>  
  ...
  <section>
    <div class="kd_wrap">
      <span>提现说明：</span>
      <ul>
        <li>1、2元及2元以上 整数可随时提现</li>
        <li>2、单笔提现手续费百分之一，最高2元</li>
        <li>3、单帐户每天提现最多十次</li>
        <li>4、提现申请时间为工作日早10:00—下午5:00</li>
        <li>5、单笔提现总金额和日提现总金额最高不超过20000元</li>
        <li>6、微信支付 规定：未实名及简化用户将无法收取企业付款（<font color="red">需在微信支付中至少绑定一张银行卡，否则无法提现</font>）</li>
      </ul>
    </div>
  </section>
