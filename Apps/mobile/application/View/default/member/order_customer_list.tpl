...
<html>
	...
	<head>
		...
		<title>我的销售订单列表 - {$config[cfg_webname]}</title>
	...
	<body>
		<section class="main">
		    <header id="common_hd" class="c_txt rel">
		        ...
		        <a id="common_hd_logo" class="t_hide abs common_hd_logo">我的销售订单</a>
		        <h1 class="hd_tle">我的销售订单{if !empty($fans_nickname)}[{$fans_nickname}]{/if}</h1>
		...
		<script type="text/javascript" src="{$BASE_V}js/order_customer_list.js"></script>
	</body>
