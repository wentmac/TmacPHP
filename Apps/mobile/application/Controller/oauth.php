...
class oauthAction extends service_Controller_mobile
{
    ...
    public function bind()
    {
        ...
        $array[ 'oauth_referer_url' ] = stripslashes( Input::cookie( 'oauth_referer', MOBILE_URL )->sql() );
    ...
    public function weixin()
    {
        $code = Input::get( 'code', '' )->string();
        $state = Input::get( 'state', '' )->string();
        $model = service_Oauth_base::factory( 'Weixin' );
        $model instanceof service_oauth_Weixin_base;
        ...
        $oauth_referer = $model->getOauth_referer( $this->redirect_uri );
        //跳到绑定页面
